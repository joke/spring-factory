...
image:https://img.shields.io/endpoint?style=flat&url=https%3A%2F%2Fbadge-api.stryker-mutator.io%2Fgithub.com%2Fjoke%2Fspring-factory%2Fmaster)[https://dashboard.stryker-mutator.io/reports/github.com/joke/spring-factory/master]
